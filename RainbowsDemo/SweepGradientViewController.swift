//
//  SweepGradientViewController.swift
//  RainbowsDemo
//
...
class SweepGradientViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        gradientLayer.configuration = Configuration.sweep(
        ...
        let gestureRecognizer = UIPanGestureRecognizer(
            target: self,
            action: #selector(SweepGradientViewController.receivedGesture(_:))
        )
    ...
    @objc func receivedGesture(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        gradientView.configuration = Configuration.sweep(
            center: centerPoint,
            angle: angle
        )
    }
